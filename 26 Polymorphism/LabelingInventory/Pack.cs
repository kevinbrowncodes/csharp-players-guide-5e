...
namespace LabelingInventory
{
    ...
    public class Pack
    {
        ...
        /* Override ToString on the Pack class to display the contents of the pack. If a pack contains water, rope, and two arrows, then a calling ToString on that Pack object could look like "Pack containing Water Rope Arrow Arrow". */
        public override string ToString()
        {
            string str1 = "Pack containing";
            string str2 = "";
